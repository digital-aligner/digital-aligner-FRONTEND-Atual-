...
class MeusPacientes extends StatefulWidget {
  static const routeName = '/meus-pacientes';

  @override
  _MeusPacientesState createState() => _MeusPacientesState();
}

class _MeusPacientesState extends State<MeusPacientes> {
              ...
              child: Column(
                children: [
                  ...
                  _pacientesListStore.getPacientesList() == null
                      ? FutureBuilder(
                          future: _pacientesListStore.fetchPacientes(),
