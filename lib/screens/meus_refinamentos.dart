...
import 'package:digital_aligner_app/widgets/lists/meus_refinamentos_list.dart';
...
class MeusRefinamentos extends StatefulWidget {
  static const routeName = '/meus-refinamentos';

  @override
  _MeusRefinamentosState createState() => _MeusRefinamentosState();
}

class _MeusRefinamentosState extends State<MeusRefinamentos> {
